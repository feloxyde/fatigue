...
struct TestAutoMsgFail : public Test {
    ...
    virtual void run(){
        ...
        res << "(1) [ERROR] expected check_equal with 10 (int) and 9 (int) to succeed, but failed." << std::endl;
        ...
        res << "(2) [ERROR] expected check_near_equal with 20 (int) and 12 (int) tolerance 2 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(3) [ERROR] expected check_near_equal with 7 (int) and 10 (int) tolerance 2 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(4) [ERROR] expected check_not_equal with 12 (int) and 12 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(5) [ERROR] expected check_less_than with 12 (int) and 10 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(6) [ERROR] expected check_less_than with 12 (int) and 12 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(7) [ERROR] expected check_less_equal with 12 (int) and 10 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(8) [ERROR] expected check_greater_than with 8 (int) and 9 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(9) [ERROR] expected check_greater_than with 10 (int) and 10 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
        ...
        res << "(10) [ERROR] expected check_greater_equal with 7 (int) and 8 (int) to succeed, but failed." << std::endl;
        assert(ss.str() == res.str());
