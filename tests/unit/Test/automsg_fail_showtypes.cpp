...
struct TestAutoMsgFail : public Test {
  ...
  virtual void run()
  {
    ...
    res << "(1) [ERROR] check_equal( 10 [int], 9 [int] ) -> true : failed." << std::endl;
    ...
    res << "(2) [ERROR] check_near_equal( 20 [int], 12 [int], 2 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(3) [ERROR] check_near_equal( 7 [int], 10 [int], 2 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(4) [ERROR] check_not_equal( 12 [int], 12 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(5) [ERROR] check_less_than( 12 [int], 10 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(6) [ERROR] check_less_than( 12 [int], 12 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(7) [ERROR] check_less_equal( 12 [int], 10 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(8) [ERROR] check_greater_than( 8 [int], 9 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(9) [ERROR] check_greater_than( 10 [int], 10 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(10) [ERROR] check_greater_equal( 7 [int], 8 [int] ) -> true : failed." << std::endl;
    assert(ss.str() == res.str());
