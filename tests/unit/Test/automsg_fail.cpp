...
struct TestAutoMsgFail : public Test {
  ...
  virtual void run()
  {
    ...
    res << "(1) [ERROR] expected check_equal( 10, 9 ) to succeed, but failed." << std::endl;
    ...
    res << "(2) [ERROR] expected check_near_equal( 20, 12, 2 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(3) [ERROR] expected check_near_equal( 7, 10, 2 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(4) [ERROR] expected check_not_equal( 12, 12 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(5) [ERROR] expected check_less_than( 12, 10 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(6) [ERROR] expected check_less_than( 12, 12 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(7) [ERROR] expected check_less_equal( 12, 10 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(8) [ERROR] expected check_greater_than( 8, 9 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(9) [ERROR] expected check_greater_than( 10, 10 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
    ...
    res << "(10) [ERROR] expected check_greater_equal( 7, 8 ) to succeed, but failed." << std::endl;
    assert(ss.str() == res.str());
